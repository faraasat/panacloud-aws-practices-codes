...
export class AwsPractice50Stack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const thingPrincipal = new iotCore.CfnThingPrincipalAttachment(
      this,
      "myThingPrincipal",
      {
        principal:
          "arn:aws:iot:us-west-2:215639672365:cert/00a858bcde1ea363fabc59e44972a2226e35d5f2ee4ec346873dcaac67a94cfa",
        thingName: thingName,
      }
    );
    ...
    const policyPrincipal = new iotCore.CfnPolicyPrincipalAttachment(
      this,
      "myPolicyPrincipal",
      {
        policyName: policyName,
