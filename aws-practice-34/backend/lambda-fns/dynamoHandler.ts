  ...
  try {
    ...
    //////////////  booking time slot /////////////////////////
      ...
      if (data.Item?.isBookingRequested) {
        const params = {
          ...
          Key: { id: event.detail.id },
          UpdateExpression:
            "set isBooked = :_isBooked, bookedBy = :_bookedBy, isBookingRequested = :_isBookingRequested, bookingRequestBy = :_bookingRequestBy",
    ...
    //////////////  adding booking time slot request /////////////////////////
      ...
      const params = {
        ...
        Key: { id: event.detail.id },
        UpdateExpression:
          "set isBookingRequested = :booleanValue, bookingRequestBy = :userName",
        ExpressionAttributeValues: {
          ":booleanValue": true,
