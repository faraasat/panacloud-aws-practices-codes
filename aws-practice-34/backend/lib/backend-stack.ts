...
export class BackendStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const restaurantTimeSlotsDS = api.addDynamoDbDataSource(
      "RestaurantTimeSlots",
      RestaurantAppTable
    );
    ...
    /* subscriber 2 */
    const phoneNoParam = new cdk.CfnParameter(this, "phoneNoParam", {
      type: "String",
    }); // taking input
    snsTopic.addSubscription(
    ...
    /* Step 1 */
    const firstStep = new stepFunctionsTasks.LambdaInvoke(
      this,
      "Dynamo_Handler_Lambda",
      { lambdaFunction: dynamoHandlerLambda }
    );
    /* Step 2 */
    const secondStep = new stepFunctionsTasks.LambdaInvoke(
      this,
      "SNS_Hanlder_Lambda",
      {
