...
export class Ex00LambdaDestinationEventBridgeStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const successRule = new event.Rule(this, "successRule", {
      ...
      targets: [new target.LambdaFunction(successLambda)],
    });
    ...
    const failRule = new event.Rule(this, "failRule", {
      ...
      targets: [new target.LambdaFunction(failLambda)],
    });
  }
}
