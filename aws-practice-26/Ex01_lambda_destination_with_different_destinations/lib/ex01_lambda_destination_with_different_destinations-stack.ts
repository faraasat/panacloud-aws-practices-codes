...
export class Ex01LambdaDestinationWithDifferentDestinationsStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    lambdainvokeTopic.addSubscription(
      new subs.LambdaSubscription(destinedLambda)
    );

    myTopic.addSubscription(
      new subs.EmailSubscription("your_email@example.com")
    ); ///Subscibe topic to your event
