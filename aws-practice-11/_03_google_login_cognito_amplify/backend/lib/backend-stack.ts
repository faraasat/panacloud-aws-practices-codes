  ...
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const provider = new cognito.UserPoolIdentityProviderGoogle(
      ...
      "googleProvider",
      {
        userPool: userPool,
        clientId:
          "12393919978-rjnn89e3up4gpjnm2uboj3o4sgb64rci.apps.googleusercontent.com", // Google Client id
        clientSecret: "8QTXkEw_1TuclNUDpnfVh0Yg", // Google Client Secret
        attributeMapping: {
    ...
    const domain = userPool.addDomain("domain", {
      cognitoDomain: {
        domainPrefix: "bootcamp-mognito-mine", // SET YOUR OWN Domain PREFIX HERE
      },
    });
